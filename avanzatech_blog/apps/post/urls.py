...
urlpatterns = [
    ...
    path('likes/post/<int:post_id>/', views.LikesPostView.as_view(), name='like_post_list'),
    path('likes/author/<int:author_id>/', views.LikesAuthorView.as_view(), name='like_author_list'),
    path('comments/post/<int:post_id>/', views.CommentsPostView.as_view(), name='comments_post_list'),
    path('comments/author/<int:author_id>/', views.CommentsAuthorView.as_view(), name='comments_author_list'),
